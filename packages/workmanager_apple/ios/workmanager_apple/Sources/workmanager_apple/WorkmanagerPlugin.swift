...
extension WorkmanagerPlugin {
    ...
    static func registerLaunchHandlerOnce(
        ...
        BGTaskScheduler.shared.register(
            ...
            } else if #available(iOS 26.0, *), Self.handleContinuedProcessingIfSupported(identifier: identifier, task: task) {
                // handled by the continued-processing scheduler (iOS 26 SDK only)
